      ...
      <div className="space-y-3.5">
        {properties.map((p, i) => (
          <div key={p.id} className="grid grid-cols-[130px_1fr_auto] items-center gap-3">
            <span className="truncate text-[11px] font-medium text-slate-600" title={p.label}>
              {p.label}
            </span>
            ...
            <span className="min-w-[64px] text-right font-mono text-[12px] font-medium tabular-nums text-slate-800">
              {p.value}
